  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.marketingResearch.home.createOrEditLabel"
          data-cy="MarketingResearchCreateUpdateHeading"
          v-text="$t('serviceReference3App.marketingResearch.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.marketingResearch.title')" for="marketing-research-title"
              >Title</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.marketingResearch.service')" for="marketing-research-service"
              >Service</label
            >
            <select
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.marketingResearch.tariff')" for="marketing-research-tariff"
              >Tariff</label
            >
