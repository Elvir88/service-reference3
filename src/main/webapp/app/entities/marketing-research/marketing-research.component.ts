...
export default class MarketingResearch extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllMarketingResearchs();
  }
  ...
  public retrieveAllMarketingResearchs(): void {
  ...
  public prepareRemove(instance: IMarketingResearch): void {
  ...
  public removeMarketingResearch(): void {
    this.marketingResearchService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('serviceReference3App.marketingResearch.deleted', { param: this.removeId });
