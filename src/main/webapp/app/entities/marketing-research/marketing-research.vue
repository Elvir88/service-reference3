<template>
  <div>
    <h2 id="page-heading" data-cy="MarketingResearchHeading">
      <span v-text="$t('serviceReference3App.marketingResearch.home.title')" id="marketing-research-heading">Marketing Researches</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('serviceReference3App.marketingResearch.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'MarketingResearchCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('serviceReference3App.marketingResearch.home.createLabel')"> Create a new Marketing Research </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && marketingResearches && marketingResearches.length === 0">
      <span v-text="$t('serviceReference3App.marketingResearch.home.notFound')">No marketingResearches found</span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="serviceReference3App.marketingResearch.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="$t('serviceReference3App.marketingResearch.delete.question', { id: removeId })"
        >
