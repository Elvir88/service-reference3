    ...
    if (this.marketingResearch.id) {
      this.marketingResearchService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.marketingResearch.updated', { param: param.id });
      ...
      this.marketingResearchService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.marketingResearch.created', { param: param.id });
