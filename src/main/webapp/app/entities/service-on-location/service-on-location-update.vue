  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.serviceOnLocation.home.createOrEditLabel"
          data-cy="ServiceOnLocationCreateUpdateHeading"
          v-text="$t('serviceReference3App.serviceOnLocation.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('serviceReference3App.serviceOnLocation.datefrom')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.serviceOnLocation.dateTo')" for="service-on-location-dateTo"
              >Date To</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceOnLocation.service')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceOnLocation.tariffGroup')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceOnLocation.pattern')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceOnLocation.location')"
