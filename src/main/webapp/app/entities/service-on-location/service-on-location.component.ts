...
export default class ServiceOnLocation extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllServiceOnLocations();
  }
  ...
  public retrieveAllServiceOnLocations(): void {
  ...
  public prepareRemove(instance: IServiceOnLocation): void {
  ...
  public removeServiceOnLocation(): void {
    this.serviceOnLocationService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('serviceReference3App.serviceOnLocation.deleted', { param: this.removeId });
