<template>
  <div>
    <h2 id="page-heading" data-cy="ServiceOnLocationHeading">
      <span v-text="$t('serviceReference3App.serviceOnLocation.home.title')" id="service-on-location-heading">Service On Locations</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('serviceReference3App.serviceOnLocation.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'ServiceOnLocationCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('serviceReference3App.serviceOnLocation.home.createLabel')"> Create a new Service On Location </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && serviceOnLocations && serviceOnLocations.length === 0">
      <span v-text="$t('serviceReference3App.serviceOnLocation.home.notFound')">No serviceOnLocations found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('datefrom')">
              <span v-text="$t('serviceReference3App.serviceOnLocation.datefrom')">Datefrom</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="serviceReference3App.serviceOnLocation.delete.question"
      ...
      <div class="modal-body">
        <p
          ...
          v-text="$t('serviceReference3App.serviceOnLocation.delete.question', { id: removeId })"
        >
