    ...
    if (this.serviceOnLocation.id) {
      this.serviceOnLocationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.serviceOnLocation.updated', { param: param.id });
      ...
      this.serviceOnLocationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.serviceOnLocation.created', { param: param.id });
