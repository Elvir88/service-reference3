  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.serviceInPacketDiscount.home.createOrEditLabel"
          data-cy="ServiceInPacketDiscountCreateUpdateHeading"
          v-text="$t('serviceReference3App.serviceInPacketDiscount.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('serviceReference3App.serviceInPacketDiscount.coefficient')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceInPacketDiscount.service')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceInPacketDiscount.tariff')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.serviceInPacketDiscount.packetDiscount')"
