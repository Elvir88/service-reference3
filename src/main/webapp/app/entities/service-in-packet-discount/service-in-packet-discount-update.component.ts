    ...
    if (this.serviceInPacketDiscount.id) {
      this.serviceInPacketDiscountService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.serviceInPacketDiscount.updated', { param: param.id });
      ...
      this.serviceInPacketDiscountService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.serviceInPacketDiscount.created', { param: param.id });
