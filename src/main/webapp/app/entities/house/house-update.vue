  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.house.home.createOrEditLabel"
          data-cy="HouseCreateUpdateHeading"
          v-text="$t('serviceReference3App.house.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.house.houseId')" for="house-houseId">House Id</label>
            <input
              type="number"
              class="form-control"
              name="houseId"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.house.location')" for="house-location">Location</label>
