<template>
  <div>
    <h2 id="page-heading" data-cy="HouseHeading">
      <span v-text="$t('serviceReference3App.house.home.title')" id="house-heading">Houses</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('serviceReference3App.house.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'HouseCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('serviceReference3App.house.home.createLabel')"> Create a new House </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && houses && houses.length === 0">
      <span v-text="$t('serviceReference3App.house.home.notFound')">No houses found</span>
    </div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="serviceReference3App.house.delete.question" data-cy="houseDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-house-heading" v-text="$t('serviceReference3App.house.delete.question', { id: removeId })">
