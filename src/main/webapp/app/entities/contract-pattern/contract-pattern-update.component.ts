    ...
    if (this.contractPattern.id) {
      this.contractPatternService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.contractPattern.updated', { param: param.id });
      ...
      this.contractPatternService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.contractPattern.created', { param: param.id });
