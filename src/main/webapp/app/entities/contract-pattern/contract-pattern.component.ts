...
export default class ContractPattern extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllContractPatterns();
  }
  ...
  public retrieveAllContractPatterns(): void {
  ...
  public prepareRemove(instance: IContractPattern): void {
  ...
  public removeContractPattern(): void {
    this.contractPatternService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('serviceReference3App.contractPattern.deleted', { param: this.removeId });
