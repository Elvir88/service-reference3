    ...
    if (this.promotionOnLocation.id) {
      this.promotionOnLocationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.promotionOnLocation.updated', { param: param.id });
      ...
      this.promotionOnLocationService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.promotionOnLocation.created', { param: param.id });
