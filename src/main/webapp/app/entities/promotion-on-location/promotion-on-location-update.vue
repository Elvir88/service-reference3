  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.promotionOnLocation.home.createOrEditLabel"
          data-cy="PromotionOnLocationCreateUpdateHeading"
          v-text="$t('serviceReference3App.promotionOnLocation.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('serviceReference3App.promotionOnLocation.title')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.promotionOnLocation.dateFrom')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.promotionOnLocation.dateTo')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.promotionOnLocation.packetDiscount')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.promotionOnLocation.marketingResearch')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('serviceReference3App.promotionOnLocation.location')"
