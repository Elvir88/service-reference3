<template>
  <div>
    <h2 id="page-heading" data-cy="ServiceHeading">
      <span v-text="$t('serviceReference3App.service.home.title')" id="service-heading">Services</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('serviceReference3App.service.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'ServiceCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('serviceReference3App.service.home.createLabel')"> Create a new Service </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && services && services.length === 0">
      <span v-text="$t('serviceReference3App.service.home.notFound')">No services found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('serviceId')">
              <span v-text="$t('serviceReference3App.service.serviceId')">Service Id</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="serviceReference3App.service.delete.question" data-cy="serviceDeleteDialogHeading" v-text="$t('entity.delete.title')"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-service-heading" v-text="$t('serviceReference3App.service.delete.question', { id: removeId })">
