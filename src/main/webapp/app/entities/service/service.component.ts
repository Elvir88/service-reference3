...
export default class Service extends Vue {
  ...
  public retrieveAllServices(): void {
  ...
  public prepareRemove(instance: IService): void {
  ...
  public removeService(): void {
    this.serviceService()
      ...
      .then(() => {
        const message = this.$t('serviceReference3App.service.deleted', { param: this.removeId });
