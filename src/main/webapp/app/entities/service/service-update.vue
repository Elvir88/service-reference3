  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.service.home.createOrEditLabel"
          data-cy="ServiceCreateUpdateHeading"
          v-text="$t('serviceReference3App.service.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.service.serviceId')" for="service-serviceId"
              >Service Id</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.service.title')" for="service-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
