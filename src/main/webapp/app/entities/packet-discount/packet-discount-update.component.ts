    ...
    if (this.packetDiscount.id) {
      this.packetDiscountService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.packetDiscount.updated', { param: param.id });
      ...
      this.packetDiscountService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('serviceReference3App.packetDiscount.created', { param: param.id });
