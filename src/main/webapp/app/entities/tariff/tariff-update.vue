  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="serviceReference3App.tariff.home.createOrEditLabel"
          data-cy="TariffCreateUpdateHeading"
          v-text="$t('serviceReference3App.tariff.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.tariff.title')" for="tariff-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('serviceReference3App.tariff.cost')" for="tariff-cost">Cost</label>
            <input
              type="number"
              class="form-control"
              name="cost"
