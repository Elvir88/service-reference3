...
public interface ServiceRepository extends JpaRepository<Service, Long> {
    ...
    @Query(
        value = "select distinct service from Service service left join fetch service.service",
    ...
    @Query("select distinct service from Service service left join fetch service.service")
    List<Service> findAllWithToOneRelationships();

    @Query("select service from Service service left join fetch service.service where service.id =:id")
